...
// Exercise 2. Write a function called stringIncludes, which accepts two strings: the first string is a word and the second string is a
// single character.
...
console.log(stringIncludes('berry', 'e')); // --> true

// Exercise 3. Write a function called stringLastIndexOf, which accepts two strings: the first is a word and the second is a single 
// character.
...
// Exercise 4. Write a function called removeFromString, which accepts a string, a starting index (number) and a number of characters to 
// remove.
...
function removeFromString(string, startingIndex, num) {
  return string.slice(0, startingIndex) + string.slice(startingIndex + num);
}
...
console.log(indexOf([1, 2], 10)); // --> -1
console.log(indexOf([1, 2, 1, 1], 1)); // --> 0

// Exercise 6. Write a function called includes which accepts a collection, a value, and an optional starting index. The function should 
// return true if the value exists in the collection when we search starting from the starting index. Otherwise, it should return false.
// The collection can be a string, an array, or an object. If the collection is a string or array, the third parameter is a starting 
// index for where to search from. If the collection is an object, the function searches for the value among values in the object; since 
